resource "biot_template" "ManufacturingFloorUser" {
  analytics_db_configuration = {
    name = "ManufacturingFloorUser"
  }
  builtin_attributes = [
    {
      analytics_db_configuration = {
    ...
    },
    {
      ...
      reference_configuration = {
        ...
        referenced_side_attribute_display_name = "Manufacturing Floor Users"
        referenced_side_attribute_name = "Manufacturing Floor Users"
        uniquely = false
  ...
  custom_attributes = [  ]
  description = "Manufacturing Floor User"
  display_name = "Manufacturing Floor User"
