resource "biot_template" "OrganizationAdmin" {
  ...
  builtin_attributes = [
    ...
    },
    {
      ...
      reference_configuration = {
        ...
        referenced_side_attribute_display_name = "Organization Admin Users"
        referenced_side_attribute_name = "Organization Admin Users"
        uniquely = false
