resource "biot_template" "ManufacturerOperator" {
  analytics_db_configuration = {
    name = "ManufacturerOperator"
  }
  builtin_attributes = [
    {
      analytics_db_configuration = {
    ...
    },
    {
      ...
      reference_configuration = {
        ...
        referenced_side_attribute_display_name = "Manufacturer Operator Users"
        referenced_side_attribute_name = "Manufacturer Operator Users"
        uniquely = false
  ...
  custom_attributes = [  ]
  description = "Manufacturer Operator"
  display_name = "Manufacturer Operator"
