resource "biot_template" "BioTSupport" {
  ...
  builtin_attributes = [
    ...
    },
    {
      ...
      reference_configuration = {
        ...
        referenced_side_attribute_display_name = "BioT Support Users"
        referenced_side_attribute_name = "BioT Support Users"
        uniquely = false
  ...
  custom_attributes = [  ]
  description = "BioT Support"
  display_name = "BioT Support"
