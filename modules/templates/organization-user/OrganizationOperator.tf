resource "biot_template" "OrganizationOperator" {
  analytics_db_configuration = {
    name = "OrganizationOperator"
  }
  builtin_attributes = [
    {
      analytics_db_configuration = {
    ...
    },
    {
      ...
      reference_configuration = {
        ...
        referenced_side_attribute_display_name = "Organization Operator Users"
        referenced_side_attribute_name = "Organization Operator Users"
        uniquely = false
  ...
  custom_attributes = [  ]
  description = "Organization Operator"
